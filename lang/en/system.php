...
return [
    ...
    'labels' => [
        ...
        'profit' => 'Profit',
        'leader_gets_profit' => 'Auto-transfer Profit (exchange rate margin) as Leader income',
        'handler_split' => 'Handler Split (Accounting)',
        ...
        'split_by_margin_percentage' => 'Split by margin percentage',
        'leader' => 'Leader',
        'handler' => 'Handler',
    ...
    'actions' => [
        ...
        'export_to_sheet' => 'Sync to Google Sheet',
    ...
    'placeholders' => [
        ...
        'username_hint' => 'Username without spaces or accents (e.g., johnsmith)',
    ...
    'notifications' => [
        ...
        'sync_from_google_sheet' => 'Sync FROM Google Sheet',
        'sync_from_confirm_msg' => 'The system will pull data from Google Sheets and update the Database based on ID. Existing records will be overwritten. Do you want to continue?',
        'sync_from_success_msg' => 'Sync Successful! Updated :updated and created :created record(s). (Failed: :failed)',
        'sync_error' => 'Sync Error',
        'no_records_found' => 'No records found!',
        'no_records_to_sync' => 'No data matches the current filters to sync.',
        'spreadsheet_id' => 'Google Spreadsheet ID',
        'sheet_name' => 'Sheet Name (Tab)',
        'spreadsheet_id_helper_import' => 'Paste the Google Sheet ID to IMPORT data from.',
        'spreadsheet_id_helper_export' => 'Paste the Google Sheet ID to EXPORT data to.',
    ...
    'widgets' => [
        ...
        'cashback_pending_desc' => 'Cashback pending',
    ...
    'payout_logs' => [
        ...
        'fields' => [
            ...
            'total_pending' => 'Total Pending Cashback',
